...
namespace UralicNLP
{
    ...
    public class StringProcessing
    {
        ...
        Dictionary<string, string> IsoCodes;

        public string IsoToName(string iso)
        {
            if (IsoCodes.ContainsKey(iso))
            {
                return IsoCodes[iso];
            }
            return null;
...
{"zzj", "Zuojiang Zhuang"}
        ...
        public static string FilterArabic(string word, bool keepVowels, string combineBy)
        {
            ...
            MatchCollection matches = Regex.Matches(word, rege);
